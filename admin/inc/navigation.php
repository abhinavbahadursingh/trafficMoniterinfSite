              ...
              <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-header">Camera Feed</li>
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=camera" class="nav-link nav-camera">
                    ...
                    <li class="nav-header">Real Time Charts Feed</li>
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=charts" class="nav-link nav-chart">
                    ...
                    <li class="nav-header">Accidents</li>
                    <li class="nav-item dropdown">
                    <a href="<?php echo base_url ?>admin/?page=Accidents/" class="nav-link nav-accident">
